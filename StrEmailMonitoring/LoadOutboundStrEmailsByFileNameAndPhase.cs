...
namespace StrEmailMonitoring
{
    ...
    /// </summary>
    public sealed class LoadOutboundStrEmailsByFileNameAndPhase : NativeActivity<int>
    {
        #region .    Activity Name    .
        public LoadOutboundStrEmailsByFileNameAndPhase()
        {
            this.DisplayName = "LoadOutboundStrEmailsByFileNameAndPhase";
        }
        #endregion
        ...
        protected override void Execute(NativeActivityContext context)
        {
            try
            {
                ...
                string phase = this.In_Phase.Get(context);
                ...
                DataTable resultDT = oseh.LoadFileNameAndPhaseFromDb(fileName, phase, perBatch, currentBatch);
